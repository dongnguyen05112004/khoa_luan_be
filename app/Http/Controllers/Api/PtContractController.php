...
class PtContractController extends Controller
{
    ...
    {
        $contracts = PtContract::with(['user', 'trainer.user', 'branch'])
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(PtContract::create($data)->load(['user', 'trainer.user', 'branch']), 201);
    }

    /** GET /api/pt-contracts/{id} */
    public function show($id)
    {
        return response()->json(PtContract::with(['user', 'trainer.user', 'branch', 'bookings'])->findOrFail($id));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json($contract->load(['user', 'trainer.user', 'branch']));
    }
