    ...
    public function run(): void
    {
        ...
        $data = [
            [
                ...
                'experience'     => 5,
                'description'    => 'Chuyên gia tăng cơ với hơn 5 năm kinh nghiệm huấn luyện cá nhân và nhóm.',
                'pt_rate'        => 300000,
                'max_sessions'   => 20,
            ],
            [
                ...
                'experience'     => 3,
                'description'    => 'HLV Yoga và Zumba năng động, tốt nghiệp chứng chỉ quốc tế ACE.',
                'pt_rate'        => 250000,
                'max_sessions'   => 25,
            ],
            [
                ...
                'experience'     => 7,
                'description'    => 'Cựu vận động viên PowerLifting quốc gia, chuyên xây dựng sức mạnh toàn thân.',
                'pt_rate'        => 350000,
                'max_sessions'   => 15,
            ],
        ];
