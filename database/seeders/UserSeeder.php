...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            [
                'name'        => 'Manager BinhThanh',
                'full_name'   => 'Phạm Quản Lý',
                'email'       => 'manager.bt@gym.vn',
                'password'    => Hash::make('password'),
                'role_id'     => 2,
                'branch_id'   => 3,
                'phone'       => '0902222224',
